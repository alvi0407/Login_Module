...
export default function Admin({dataFromTabHeading}) {
  ...
  return (
    <div className="Admin">
      ...
      {dataFromTabHeading?
        ...
        <Button variant="primary" type="submit" onClick={dataFromTabHeading?addAdmin:loginUser} disabled={!validateForm()}>
          Submit
        </Button>
